# This part of networks architecture is copied from the raw Stitch3D repo with minor modifications.
...
class DeconvNet(nn.Module):
    def __init__(self,
        ...
        # decoder layers
        self.decoder_layer1 = GATMultiHead(hidden_dims[2] + slice_emb_dim, hidden_dims[1], n_heads=n_heads,
                                           concat_heads=True)
