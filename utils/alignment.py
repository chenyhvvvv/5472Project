...
def align_slices(logger, adata_st_list_input, # list of spatial transcriptomics datasets
    ...
    if (method == "icp") or (method == "ICP"):
        logger.info("======> Using the Iterative Closest Point algorithm for alignemnt.")
        # Detect edges
        ...
        logger.info("======> Using PASTE algorithm for alignemnt.")
        # Align spots
        logger.info("======> Aligning spots...")
        pis = []
        # Calculate pairwise transformation matrices
        for i in range(len(adata_st_list) - 1):
