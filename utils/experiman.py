...
class ExperiMan(object):
    ...
    by calling : logger = manager.get_logger()
        logger can record the output
            both in the commandline and the .log file.
    ...
    def get_basic_arg_parser(self):
        ...
        parser.add_argument('--code_dir', type=str, default="./", help="code dir (for backup)")
        parser.add_argument('--data_dir', type=str, default="/import/home2/yhchenmath/Dataset/stitch3D", help="data dir")
        # ======> Setting run_dir
        parser.add_argument('--log_dir', type=str, default="/import/home2/yhchenmath/Log/stitch3D", help="root dir for logging")
        parser.add_argument('--exp_name', type=str, default="stitch3d", help="name of the experiment")
        parser.add_argument('--run_name', type=str, default="UNDEFINED", help="name of this run")
